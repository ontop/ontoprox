...
'http://www.example.org/fresh#fresh10'(Y) :- 'http://uob.iodt.ibm.com/univ-bench-dl.owl#hasStudent'(X,Y),'http://uob.iodt.ibm.com/univ-bench-dl.owl#Organization'(X).
...
'http://www.example.org/fresh#fresh1'(Y) :- 'http://uob.iodt.ibm.com/univ-bench-dl.owl#teachingAssistantOf'(Y,X),'http://uob.iodt.ibm.com/univ-bench-dl.owl#Course'(X).
...
'http://www.example.org/fresh#fresh8'(Y) :- 'http://uob.iodt.ibm.com/univ-bench-dl.owl#hasStudent'(X,Y),'http://uob.iodt.ibm.com/univ-bench-dl.owl#WomanCollege'(X).
...
'http://www.example.org/fresh#fresh14'(Y) :- 'http://uob.iodt.ibm.com/univ-bench-dl.owl#Sports'(X),'http://uob.iodt.ibm.com/univ-bench-dl.owl#isCrazyAbout'(Y,X).
