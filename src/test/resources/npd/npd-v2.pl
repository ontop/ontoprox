...
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#AppraisalWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#AwardArea'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#BAA'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#BAAArea'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#BAALicensee'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#BAATransfer'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Block'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#BlowoutWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ChangeOfCompanyNameTransfer'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Company'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#CompanyReserve'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ConcreteStructureFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Condeep3ShaftsFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Condeep4ShaftsFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#CondeepMonoshaftFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#CondensatePipeline'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DevelopmentWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Discovery'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DiscoveryArea'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DiscoveryReserve'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DorisFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ElectromagneticSurvey'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ExplorationWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FPSOFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FSUFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FacilityPoint'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FeederPipeline'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Field'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FieldArea'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FieldInvestment'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FieldLicensee'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FieldMonthlyProduction'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FieldOperator'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FieldOwner'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#FieldReserve'/1.
...
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#JackUp4LegsFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Jacket12LegsFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Jacket4LegsFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Jacket6LegsFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Jacket8LegsFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#JacketTripodFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#JunkedWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#LandfallFacility'/1.
...
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#MoveableFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#MultiFieldWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#MultiWellTemplateFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#MultilateralWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#NCSMonthlyProduction'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#NCSYearlyProduction'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ObservationWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#OilGasPipeline'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#OilPipeline'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#OnshoreFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#OtherSurvey'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#PAWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ParcellBAA'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Pipeline'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicence'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceArea'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceAreaPerBlock'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceLicensee'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceOperator'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceStatus'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceTransfer'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionLicenceWorkObligation'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ProductionWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Quadrant'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ReClassToDevWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ReClassToTestWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ReEntryWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#RegularSeismicSurvey'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#RouteSurvey'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SDFITransfer'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SeabedSeismicSurvey'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SeismicAreaBAA'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SeismicSurvey'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SeismicSurveyCoordinate'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SeismicSurveyProgress'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SemisubConcreteFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SemisubSteelFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ShallowWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SidetrackWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SingleWellTemplateFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SiteSurvey'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SlidingScaleBAA'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SubseaStructureFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SurveyArea'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SurveyMultilineArea'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SuspReenteredLaterWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SuspendedWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#TUFOperator'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#TUFOwner'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#TUFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#TlpConcreteFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#TlpSteelFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Transfer'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#TransportationPipeline'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#UnitizedBAA'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#VesselFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Well'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#Wellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreCasingAndLeakoffTest'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreCoordinate'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreCore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreCorePhoto'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreCoreSet'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreDocument'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreDrillStemTest'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreDrillingMudSample'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreOilSample'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellborePoint'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreStratigraphicCoreSet'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WellboreStratum'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#WildcatWellbore'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#ChangedAwardNotification'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#DeletedEasementNotification'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#EasementNotification'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#NewAwardNotification'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#ProductionLicence'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#ProductionLicenceLicensee'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#ProductionLicenceNotification'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFLicensee'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFNotification'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFacility'/1.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTBottomHolePressure'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTChokeSize'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTDepthFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTDepthTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTFinalFlowPressure'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTFinalShutInPressure'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTGasDensity'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTGasOilRelation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTGasProducedRate'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTOilDensity'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTOilProducedRate'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#DSTTestNo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#LOTForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#LOTMudDensity'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#SDFI'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#TUFOwnerShare'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ZValueFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ZValueTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#areaSize'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#areaSize3DKm2'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#baaLicensee'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#baaOperatorCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#baaTransferCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#belongsToFacility'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#belongsToWell'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#blockId'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#blockLocation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#casingDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#casingDiameter'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#casingType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#codeEW'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#codeNS'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#companyGroup'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#companyShare'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#containsWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coordinateForSurvey'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coordinateForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coreForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coreIntervalBottom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coreIntervalTop'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coreIntervalUOM'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coreNo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#corePhotoForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#corePhotoTitle'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#corePhotoURL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coresForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coresTotalLength'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#coresTotalNo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#country'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#currentAreaSize'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#currentFieldOperator'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#currentFieldOwner'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#currentResponsibleCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#currentStatus'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateApproved'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateBaaAreaValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateBaaAreaValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateBaaLicenseeValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateBaaLicenseeValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateBaaValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateBaaValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateFieldLicenseeFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateFieldLicenseeTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateFieldOperatorFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateFieldOperatorTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateFieldOwnerFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateFieldOwnerTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateIncludedInField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateInitialStatusTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateLicenceAreaValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateLicenceAreaValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateLicenceGranted'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateLicenceValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateLicenseeValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateLicenseeValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateMudMeasured'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateOilSampleReceived'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateOilSampleTest'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateOperatorValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateOperatorValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateProductionStart'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateResourceEstimate'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateStatusFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateStatusTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateStatusValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateStatusValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateSurveyActualCompleted'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateSurveyActualStart'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateSurveyPlannedCompleted'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateSurveyPlannedStart'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateSurveyProgress'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateSyncNPD'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateTUFOperatorValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateTUFOperatorValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateTUFOwnerValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateTUFOwnerValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateTaskExpiry'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateTransferValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateUpdated'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateUpdatedMax'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateWDSSQC'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateWellboreCompletion'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dateWellboreEntry'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#decimalDegreesEW'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#decimalDegreesNS'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#degreesEW'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#degreesNS'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#dependsOnTask'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#designLifetime'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#developmentWellboreForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#developmentWellboreForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#discoveryWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#discoveryYear'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#documentForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#documentFormat'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#documentName'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#documentSize'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#documentType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#documentURL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#drillPermit'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#drillingFacility'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#drillingOperatorCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#explorationWellboreForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#explorationWellboreForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#facilityFunction'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#facilityType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#factMapURL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#factPageURL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#fieldLicensee'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#fieldOperator'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#geochronologicEra'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#geodeticDatum'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#hydrocarbonType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#idNPD'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#inLithostratigraphicUnit'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#includedInField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#investmentForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#investmentNOK'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isActive'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isCoreSampleAvailable'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isCurrentLicenceLicensee'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isCurrentLicenceOperator'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isDiscoveryWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isFormerLicenceLicensee'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isFormerLicenceOperator'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isGeometryOfFeature'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isGeotechnicalMeasurement'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isMarketAvailable'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isMultilateral'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isReentryWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isSamplingPerformed'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isShallowDrillingPerformed'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isStratigraphical'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isSurfaceFacility'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#isTurnAreaIncluded'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#lastOperatorCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#lengthBoatTotalKm'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#lengthCdpTotalKm'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#lengthPlannedBoatKm'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#lengthPlannedCdpKm'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licenceLicensee'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licenceOperatorCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licenceTransferCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licenseeForBAA'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licenseeForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licenseeForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licenseeInterest'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#licensingActivityName'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mainAreaLocation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mapNo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#member'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#messageForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#minutesEW'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#minutesNS'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mudMeasuredDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mudTestForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mudType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mudViscosity'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mudWeight'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#mudYieldPoint'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#name'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#npdPageURL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#oilSampleBottomDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#oilSampleFluidType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#oilSampleTestForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#oilSampleTestNumber'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#oilSampleTestType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#oilSampleTopDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#operatorForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#operatorForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#originalAreaSize'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#ownerForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#pipelineDimension'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#pipelineFromFacility'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#pipelineMainGrouping'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#pipelineMedium'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#pipelineOperator'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#pipelineToFacility'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#polygonNo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#polygonPointNo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#pressReleaseURL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#producedCondensate'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#producedGas'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#producedNGL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#producedOil'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#producedOilEquivalents'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#producedWater'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#productionFacility'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#productionForDiscovery'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#productionForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#productionMonth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#productionYear'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#provinceLocation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#quadrantLocation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#reclassedFromWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#recoverableCondensate'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#recoverableGas'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#recoverableNGL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#recoverableOil'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#recoverableOilEquivalents'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#registeredInCountry'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#remainingCondensate'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#remainingGas'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#remainingNGL'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#remainingOil'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#remainingOilEquivalents'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#reportingCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#reservesForCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#reservesForDiscovery'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#reservesForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#reservesResourceClass'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#resourcesIncludedInDiscovery'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#secondsEW'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#secondsNS'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#sensorLength'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#sensorNumbers'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#sensorType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#shallowWellboreForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#shortName'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#sourceNumber'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#sourcePressure'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#sourceSize'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#sourceType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#status'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#statusForField'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#statusForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#statusForSurvey'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#stratigraphicLevel'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#stratigraphicParent'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#stratumForWellbore'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#surveySubType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#surveyType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#taskForCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#taskForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#taskID'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#taskType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#transferDirection'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#transferredBAA'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#transferredInterest'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#transferredLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#utmEW'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#utmNS'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#utmZone'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#waterDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellOperator'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreAgeHcLevel1'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreAgeHcLevel2'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreAgeHcLevel3'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreAgeTD'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreBottomHoleTemperature'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreCompletionYear'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreContent'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreDrillingDays'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreEntryYear'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreFinalVerticalDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreForDiscovery'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreFormationHcLevel1'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreFormationHcLevel2'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreFormationHcLevel3'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreFormationTD'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreHoleDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreHoleDiameter'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreKellyBushElevation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreLicensingActivity'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreMaxInclation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreNamePart1'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreNamePart2'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreNamePart3'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreNamePart4'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreNamePart5'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreNamePart6'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreParent'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellborePlannedContent'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellborePlannedPurpose'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellborePlotSymbol'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellborePurpose'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreReentryExplorationActivity'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreSeismicLocation'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreStratumBottomDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreStratumTopDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreTotalDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreWaterDepth'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2#wellboreWellType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFLicenceeCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFLicenceeForTUF'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFOperatorCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFOperatorForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFOwnerCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#TUFOwnerForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#dateAwarded'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#dateLicenceValidFrom'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#dateLicenceValidTo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#dateMessageRegistered'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#dateUpdated'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#dateUpdatedMax'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#licenceLicenceeCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#licenceOperatorCompany'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#licenceeForLicence'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#licenseeInterest'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#messageForTUF'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#messageNo'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#messageType'/2.
:- discontiguous 'http://sws.ifi.uio.no/vocab/npd-v2-ptl#name'/2.
...
'http://www.example.org/fresh#fresh2'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#DependentContinuant'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#MaterialEntity'(X),'http://www.ifomis.org/bfo/1.1/snap#Site'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#MaterialEntity'(X),'http://www.ifomis.org/bfo/1.1/snap#ObjectBoundary'(X).
...
'http://www.example.org/fresh#fresh1'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#IndependentContinuant'(X).
...
'http://www.example.org/fresh#fresh5'(X) :- 'http://www.ifomis.org/bfo/1.1#Entity'(X).
...
'http://www.example.org/fresh#fresh3'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#SpatialRegion'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#ObjectAggregate'(X),'http://www.ifomis.org/bfo/1.1/snap#FiatObjectPart'(X).
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.w3.org/2004/02/skos/core#Concept'(X),'http://www.w3.org/2004/02/skos/core#ConceptScheme'(X).
...
'http://www.example.org/fresh#fresh11'(X) :- 'http://www.ifomis.org/bfo/1.1/span#Occurrent'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#OneDimensionalRegion'(X),'http://www.ifomis.org/bfo/1.1/snap#TwoDimensionalRegion'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#ObjectAggregate'(X),'http://www.ifomis.org/bfo/1.1/snap#Object'(X).
...
'http://www.example.org/fresh#fresh10'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#SpecificallyDependentContinuant'(X).
...
'http://www.example.org/fresh#fresh7'(X) :- 'http://www.example.org/fresh#fresh6'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://sws.ifi.uio.no/vocab/npd-v2#Formation'(X),'http://sws.ifi.uio.no/vocab/npd-v2#Member'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.opengis.net/ont/geosparql#Geometry'(X),'http://www.opengis.net/ont/geosparql#Feature'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/span#ProcessBoundary'(X),'http://www.ifomis.org/bfo/1.1/span#Process'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://sws.ifi.uio.no/vocab/npd-v2#Group'(X),'http://sws.ifi.uio.no/vocab/npd-v2#Member'(X).
...
'http://www.example.org/fresh#fresh14'(X) :- 'http://www.ifomis.org/bfo/1.1/span#ConnectedSpatiotemporalRegion'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#TwoDimensionalRegion'(X),'http://www.ifomis.org/bfo/1.1/snap#ZeroDimensionalRegion'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/span#FiatProcessPart'(X),'http://www.ifomis.org/bfo/1.1/span#ProcessualContext'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.w3.org/2004/02/skos/core#Concept'(X),'http://www.w3.org/2004/02/skos/core#Collection'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#OneDimensionalRegion'(X),'http://www.ifomis.org/bfo/1.1/snap#ZeroDimensionalRegion'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#Continuant'(X),'http://www.ifomis.org/bfo/1.1/span#Occurrent'(X).
'http://www.ifomis.org/bfo/1.1/snap#RealizableEntity'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#Role'(X).
'http://www.example.org/fresh#fresh4'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#MaterialEntity'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#Quality'(X),'http://www.ifomis.org/bfo/1.1/snap#RealizableEntity'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#ObjectAggregate'(X),'http://www.ifomis.org/bfo/1.1/snap#Site'(X).
...
'http://www.example.org/fresh#fresh15'(X) :- 'http://www.ifomis.org/bfo/1.1/span#SpatiotemporalRegion'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/span#TemporalRegion'(X),'http://www.ifomis.org/bfo/1.1/span#ProcessualEntity'(X).
...
'http://www.example.org/fresh#fresh12'(X) :- 'http://www.ifomis.org/bfo/1.1/span#ConnectedTemporalRegion'(X).
...
'http://www.example.org/fresh#fresh8'(X) :- 'http://www.ifomis.org/bfo/1.1/span#TemporalRegion'(X).
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#ThreeDimensionalRegion'(X),'http://www.ifomis.org/bfo/1.1/snap#ZeroDimensionalRegion'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/span#FiatProcessPart'(X),'http://www.ifomis.org/bfo/1.1/span#Process'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/span#ProcessBoundary'(X),'http://www.ifomis.org/bfo/1.1/span#ProcessualContext'(X).
'http://www.example.org/fresh#fresh9'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#Continuant'(X).
...
'http://sws.ifi.uio.no/vocab/npd-v2#Group'(Y) :- 'http://sws.ifi.uio.no/vocab/npd-v2#Formation'(X),'http://sws.ifi.uio.no/vocab/npd-v2#stratigraphicParent'(X,Y).
...
'http://sws.ifi.uio.no/vocab/npd-v2#Formation'(Y) :- 'http://sws.ifi.uio.no/vocab/npd-v2#stratigraphicParent'(X,Y),'http://sws.ifi.uio.no/vocab/npd-v2#Member'(X).
...
'http://www.example.org/fresh#_eliminatedtransfresh_2'(Y) :- 'http://www.w3.org/2004/02/skos/core#narrowerTransitive'(X,Y).
'http://www.opengis.net/ont/geosparql#SpatialObject'(Y) :- 'http://www.opengis.net/ont/geosparql#ehInside'(X,Y).
'http://www.example.org/fresh#_eliminatedtransfresh_3'(Y) :- 'http://www.w3.org/2004/02/skos/core#broaderTransitive'(X,Y),'http://www.example.org/fresh#_eliminatedtransfresh_3'(X).
...
'http://www.example.org/fresh#fresh6'(Y) :- 'http://www.w3.org/2004/02/skos/core#member'(X,Y).
...
'http://www.example.org/fresh#_eliminatedtransfresh_2'(Y) :- 'http://www.w3.org/2004/02/skos/core#narrowerTransitive'(X,Y),'http://www.example.org/fresh#_eliminatedtransfresh_2'(X).
...
'http://www.example.org/fresh#_eliminatedtransfresh_0'(Y) :- 'http://www.w3.org/2004/02/skos/core#narrowerTransitive'(X,Y),'http://www.example.org/fresh#_eliminatedtransfresh_0'(X).
...
'http://www.example.org/fresh#_eliminatedtransfresh_3'(Y) :- 'http://www.w3.org/2004/02/skos/core#broaderTransitive'(X,Y).
