...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#SpatialRegion'(X),'http://www.ifomis.org/bfo/1.1/snap#IndependentContinuant'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/span#SpatiotemporalInstant'(X),'http://www.ifomis.org/bfo/1.1/span#SpatiotemporalInterval'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/snap#SpatialRegion'(X),'http://www.ifomis.org/bfo/1.1/snap#DependentContinuant'(X).
...
'http://www.w3.org/2002/07/owl#Nothing'(X) :- 'http://www.ifomis.org/bfo/1.1/span#ScatteredTemporalRegion'(X),'http://www.ifomis.org/bfo/1.1/span#ConnectedTemporalRegion'(X).
...
'http://www.example.org/fresh#_eliminatedtransfresh_2'(Y) :- 'http://www.example.org/fresh#_eliminatedtransfresh_2'(X),'http://www.w3.org/2004/02/skos/core#narrowerTransitive'(X,Y).
...
'http://www.example.org/fresh#Formation_and_LithostratigraphicUnit'(X) :- 'http://sws.ifi.uio.no/vocab/npd-v2#Formation'(X),'http://sws.ifi.uio.no/vocab/npd-v2#LithostratigraphicUnit'(X).
'http://www.example.org/fresh#LithostratigraphicUnit_and_Member'(X) :- 'http://sws.ifi.uio.no/vocab/npd-v2#LithostratigraphicUnit'(X),'http://sws.ifi.uio.no/vocab/npd-v2#Member'(X).
