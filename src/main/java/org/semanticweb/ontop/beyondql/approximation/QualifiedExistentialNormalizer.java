...
public class QualifiedExistentialNormalizer extends OntologyTransformations {
     ...
     *
     * @param ontology  in Horn-ALCHIQ normal form
     * @param outputIRI the IRI of the new ontology
    ...
    public OWLOntology transform(
        ...
        for (OWLAxiom axiom : ontology.getAxioms()) {
            if (requiresSubstitutionOfQualifiedExistentialRestrictionOnRHS(axiom)) {
                axioms.addAll(substituteQualifiedExistentialRestrictionOnRHS((OWLSubClassOfAxiom) axiom));
            } else {
                axioms.add(axiom);
            }
        }
